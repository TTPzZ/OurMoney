      ...
      <div className="w-full max-w-sm space-y-8 text-center">
        ...
        <div className="pt-8">
          ...
          >
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-3 rounded-xl bg-white px-6 py-4 text-lg font-semibold text-gray-700 shadow-md border border-gray-200 transition-transform active:scale-95 min-h-[56px] hover:bg-gray-50"
            >
