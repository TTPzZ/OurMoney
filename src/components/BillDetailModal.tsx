          ...
          <Card className="p-5 bg-white border-none shadow-sm space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-slate-900">{bill.description}</p>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between p-4 bg-indigo-600 rounded-2xl shadow-lg shadow-indigo-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-white text-sm">{bill.paidBy.name}</p>
                  </div>
                </div>
                <div className="text-right flex flex-col items-end gap-2">
                  <p className="text-xs font-black text-white">₫{bill.totalAmount.toLocaleString()}</p>
                  <button
                    type="button"
                    onClick={() => {
                      if (bill.paidBy.hasPaymentQR) setShowQR(true);
                    }}
                    disabled={!bill.paidBy.hasPaymentQR}
